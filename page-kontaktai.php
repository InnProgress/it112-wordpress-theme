...
<div class="flex flex-col-reverse md:flex-row mb-14 mt-6 lg:mb-0">
  ...
  <div class="flex-1 mb-4 md:mb-0">
    <img src="<?php echo get_template_directory_uri(); ?>/img/get-in-touch.png" class="mx-auto lg:mr-0 w-10/12" alt="Kompiuterių taisykla Vilniuje">
  </div>
</div>
...
<div class="flex flex-col md:flex-row mb-14 lg:mb-10">
  ...
  <div class="flex-1 self-center text-center md:text-left">
    <h2 class="text-2xl md:text-4xl font-bold mb-1 md:mb-4">Itin patogus susisiekimas!</h2>
...
<div class="flex flex-col-reverse lg:flex-row mb-14 md:mb-0"> 
  <div class="lg:w-6/12 self-center">
    <div class="lg:w-10/12">
      <h2 class="text-2xl md:text-4xl font-bold text-center lg:text-left mb-1 md:mb-4">Kreipkitės jau dabar!</h2>
