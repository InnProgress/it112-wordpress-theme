...
<div class="flex flex-col-reverse md:flex-row md:max-lg:mt-14 mb-14 lg:mb-0">
  <div class="flex-1 self-center text-center md:text-left">
    ...
    <p class="text-lg md:text-2xl my-2 md:my-5">Taisome nešiojamus ir stacionarius kompiuterius. Greitai nustatome gedimus ir kokybiškai juos pašaliname. Galime sukomplektuoti bei patobulinti stacionarius kompiuterius pagal visus Jūsų poreikius</p>
