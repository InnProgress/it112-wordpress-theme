...
<div class="flex flex-col-reverse lg:flex-row mb-14 md:mb-0">
  <div class="status-check-container self-center w-full lg:w-6/12 text-center lg:text-left">
    <h2 class="text-2xl md:text-4xl font-bold uppercase mb-2 md:mb-4">Pasitikrink savo įrenginio remonto eigą</h2>
    <p class="text-md md:text-xl my-2 md:my-5">Remonto numeris yra nurodytas kompiuterio priėmimo akte <strong>(Rem. nr.)</strong></p>
