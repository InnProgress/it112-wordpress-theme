...
<div class="flex flex-col-reverse md:flex-row md:max-lg:mt-14 mb-14 lg:mb-0">
  <div class="flex-1 self-center text-center md:text-left">
    ...
    <p class="text-lg md:text-xl lg:text-2xl my-2 md:my-5">Esame motyvuota nešiojamų ir stacionarių kompiuterių taisykla. Didelę patirtį sukaupę specialistai pasirengę suteikti aukščiausios kokybės paslaugas. Jūsų pasitikėjimas yra mūsų prioritetas, todėl dirbame, kad užtikrintume jūsų techninės įrangos sklandų veikimą.</p>
