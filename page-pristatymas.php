...
<div class="flex flex-col-reverse lg:flex-row mt-6 mb-14 md:mb-12">
  <div class="lg:w-5/12 self-center text-center lg:text-left">
    ...
    <p class="text-lg md:text-2xl my-2 md:my-5">Jei neturite laiko atvykti patys ar gyvenate toli nuo mūsų salono, pasinaudokite kurjerių bei paštomatų pagalba.</p>
  </div>
  <div class="flex-1 mb-6 lg:mb-0">
    <img src="<?php echo get_template_directory_uri(); ?>/img/shipments.png" class="mx-auto lg:ml-auto lg:mr-0 w-10/12">
  </div>
</div>
